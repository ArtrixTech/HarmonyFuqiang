...
def new_request_process(source_socks, source_address):
    ...
    while True:
        ...
        try:
            received = source_socks.recv(1024)
        ...
        try:
            decoded_data = received.decode("gb2312")
        ...
        print(received)
        if not received or decoded_data == 'exit':
            # source_socks.close()
            # print("closed")
            break
        ...
        if buf and "CONNECT" not in buf and not is_exit:
            ...
            if connect_succeed:
                ...
                try:
                    ...
                    while data:
                        source_socks.send(base64.b64encode(data))
                        data = target_socks.recv(128)
...
proxy_server_address = ('127.0.0.1', 3467)
